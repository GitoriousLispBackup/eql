(defparameter *q-methods* '(
  ...
  (("QGLShaderProgram" . "QObject")
   ...
   "void setAttributeArray ( int , const GLfloat * , int , int = 0 )"
   ...
   "void setAttributeArray ( const char * , const GLfloat * , int , int = 0 )"
   ...
   "void setAttributeValue ( int , const GLfloat * , int , int )"
   ...
   "void setAttributeValue ( const char * , const GLfloat * , int , int )"
   ...
   "void setUniformValueArray ( int , const GLfloat * , int , int )"
