(defparameter *n-methods* '(
  ...
  (("QGLFramebufferObject" . "QPaintDevice")
   ...
   "new QGLFramebufferObject ( int , int , Attachment , GLenum = GL_TEXTURE_2D, GLenum = GL_RGBA8 )"
   "new QGLFramebufferObject ( const QSize & , Attachment , GLenum = GL_TEXTURE_2D, GLenum = GL_RGBA8 )"
  ...
  (("QSqlDatabase" . NIL)
   ...
   "new QSqlDatabase ( const QString & )"
  ...
  (("QSqlError" . NIL)
   "new QSqlError ( const QString & = QString(), const QString & = QString(), ErrorType = NoError, int = -1 )"
   "new QSqlError ( const QSqlError & )"
   "QString databaseText () const"
   "QString driverText () const"
   "bool isValid () const"
   "int number () const"
   "void setDatabaseText ( const QString & )"
   "void setDriverText ( const QString & )"
   "void setNumber ( int )"
  ...
  (("QSqlResult" . NIL)
   ...
   "new QSqlResult ( const QSqlDriver * )"
  ...
  (("QSslCertificate" . NIL)
   ...
   "bool isNull () const"
   "bool isValid () const"
   "QString issuerInfo ( SubjectInfo ) const"
   "QString issuerInfo ( const QByteArray & ) const"
   "QSslKey publicKey () const"
   "QByteArray serialNumber () const"
   "QString subjectInfo ( SubjectInfo ) const"
   "QString subjectInfo ( const QByteArray & ) const"
  ...
  (("QTabletEvent" . "QInputEvent")
   "new QTabletEvent ( Type , const QPoint & , const QPoint & , const QPointF & , int , int , qreal , int , int , qreal , qreal , int , Qt::KeyboardModifiers , qint64 )"
  ...
  (("QUrlInfo" . NIL)
   "new QUrlInfo ()"
   "new QUrlInfo ( const QUrlInfo & )"
   "new QUrlInfo ( const QString & , int , const QString & , const QString & , qint64 , const QDateTime & , const QDateTime & , bool , bool , bool , bool , bool , bool )"
   "new QUrlInfo ( const QUrl & , int , const QString & , const QString & , qint64 , const QDateTime & , const QDateTime & , bool , bool , bool , bool , bool , bool )"
   "QString group () const"
   "bool isDir () const"
   "bool isExecutable () const"
   "bool isFile () const"
