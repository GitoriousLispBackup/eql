...
public:
    ...
    Q_INVOKABLE int Mnumber(QSqlError* o) const { return o->number(); }
    Q_INVOKABLE void MsetDatabaseText(QSqlError* o, const QString& x1) { o->setDatabaseText(x1); }
    Q_INVOKABLE void MsetDriverText(QSqlError* o, const QString& x1) { o->setDriverText(x1); }
    Q_INVOKABLE void MsetNumber(QSqlError* o, int x1) { o->setNumber(x1); }
    Q_INVOKABLE void MsetType(QSqlError* o, QSqlError::ErrorType x1) { o->setType(x1); }
