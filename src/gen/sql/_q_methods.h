...
class Q164 : public Q15 { // QSqlQueryModel
    Q_OBJECT
public:
    ...
    Q_INVOKABLE QModelIndex MindexInQuery(QSqlQueryModel* o, const QModelIndex& x1) const { return ((LSqlQueryModel*)o)->indexInQuery(x1); }
...
class Q165 : public Q101 { // QSqlRelationalDelegate
    Q_OBJECT
public:
    ...
    Q_INVOKABLE void MsetEditorData(QSqlRelationalDelegate* o, QWidget* x1, const QModelIndex& x2) const { o->setEditorData(x1, x2); }
...
class Q167 : public Q164 { // QSqlTableModel
    Q_OBJECT
public:
    ...
    Q_INVOKABLE bool Mselect(QSqlTableModel* o) { return o->select(); }
    ...
    Q_INVOKABLE QModelIndex MindexInQuery(QSqlTableModel* o, const QModelIndex& x1) const { return ((LSqlTableModel*)o)->indexInQuery(x1); }
...
class Q166 : public Q167 { // QSqlRelationalTableModel
    Q_OBJECT
public:
