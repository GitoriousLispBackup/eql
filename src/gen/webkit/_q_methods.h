...
public:
    ...
    Q_INVOKABLE void Mrender(QWebFrame* o, QPainter* x1) { o->render(x1); }
    Q_INVOKABLE void Mrender(QWebFrame* o, QPainter* x1, const QRegion& x2) { o->render(x1, x2); }
    Q_INVOKABLE void Mrender(QWebFrame* o, QPainter* x1, QWebFrame::RenderLayer x2, const QRegion& x3 = QRegion()) { o->render(x1, x2, x3); }
    Q_INVOKABLE QString MrenderTreeDump(QWebFrame* o) const { return o->renderTreeDump(); }
...
class Q215 : public Q127 { // QWebHistoryInterface
    Q_OBJECT
public:
...
class Q217 : public Q127 { // QWebPage
    Q_OBJECT
public:
