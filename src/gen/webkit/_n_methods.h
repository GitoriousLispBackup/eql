...
class N183 : public QObject { // QWebElement
    Q_OBJECT
public:
...
class N184 : public QObject { // QWebElementCollection
    Q_OBJECT
public:
...
class N185 : public QObject { // QWebHistory
    Q_OBJECT
public:
...
class N186 : public QObject { // QWebHistoryItem
    Q_OBJECT
public:
...
class N187 : public QObject { // QWebHitTestResult
    Q_OBJECT
public:
...
class N188 : public QObject { // QWebSecurityOrigin
    Q_OBJECT
public:
...
class N189 : public QObject { // QWebSettings
    Q_OBJECT
public:
