...
public:
    ...
    void addHistoryEntry(const QString& x1) { void* fun = LObjects::overrideFun(unique, 349); if(fun) { const void* args[] = { &x1 }; callOverrideFun(fun, 349, args); }}
    bool historyContains(const QString& x1) const { void* fun = LObjects::overrideFun(unique, 350); bool ret = false; if(fun) { const void* args[] = { &x1 }; ret = callOverrideFun(fun, 350, args).toBool(); } return ret; }
...
public:
    ...
    bool extension(Extension x1, const ExtensionOption* x2 = 0, ExtensionReturn* x3 = 0) { void* fun = LObjects::overrideFun(unique, 351); bool ret = false; if(fun) { const void* args[] = { &x1, &x2, &x3 }; ret = callOverrideFun(fun, 351, args).toBool(); } if(!fun || LObjects::call_default) { ret = QWebPage::extension(x1, x2, x3); } return ret; }
    bool supportsExtension(Extension x1) const { void* fun = LObjects::overrideFun(unique, 352); bool ret = false; if(fun) { const void* args[] = { &x1 }; ret = callOverrideFun(fun, 352, args).toBool(); } if(!fun || LObjects::call_default) { ret = QWebPage::supportsExtension(x1); } return ret; }
    void triggerAction(WebAction x1, bool x2 = false) { void* fun = LObjects::overrideFun(unique, 353); if(fun) { const void* args[] = { &x1, &x2 }; callOverrideFun(fun, 353, args); } if(!fun || LObjects::call_default) { QWebPage::triggerAction(x1, x2); }}
    bool acceptNavigationRequest(QWebFrame* x1, const QNetworkRequest& x2, NavigationType x3) { void* fun = LObjects::overrideFun(unique, 354); bool ret = false; if(fun) { const void* args[] = { &x1, &x2, &x3 }; ret = callOverrideFun(fun, 354, args).toBool(); } if(!fun || LObjects::call_default) { ret = QWebPage::acceptNavigationRequest(x1, x2, x3); } return ret; }
    QString chooseFile(QWebFrame* x1, const QString& x2) { void* fun = LObjects::overrideFun(unique, 355); QString ret; if(fun) { const void* args[] = { &x1, &x2 }; ret = qVariantValue<QString>(callOverrideFun(fun, 355, args)); } if(!fun || LObjects::call_default) { ret = QWebPage::chooseFile(x1, x2); } return ret; }
    QObject* createPlugin(const QString& x1, const QUrl& x2, const QStringList& x3, const QStringList& x4) { void* fun = LObjects::overrideFun(unique, 356); QObject* ret = 0; if(fun) { const void* args[] = { &x1, &x2, &x3, &x4 }; ret = (QObject*)qVariantValue<void*>(callOverrideFun(fun, 356, args)); } if(!fun || LObjects::call_default) { ret = QWebPage::createPlugin(x1, x2, x3, x4); } return ret; }
    QWebPage* createWindow(WebWindowType x1) { void* fun = LObjects::overrideFun(unique, 357); QWebPage* ret = 0; if(fun) { const void* args[] = { &x1 }; ret = (QWebPage*)qVariantValue<void*>(callOverrideFun(fun, 357, args)); } if(!fun || LObjects::call_default) { ret = QWebPage::createWindow(x1); } return ret; }
    void javaScriptAlert(QWebFrame* x1, const QString& x2) { void* fun = LObjects::overrideFun(unique, 358); if(fun) { const void* args[] = { &x1, &x2 }; callOverrideFun(fun, 358, args); } if(!fun || LObjects::call_default) { QWebPage::javaScriptAlert(x1, x2); }}
    bool javaScriptConfirm(QWebFrame* x1, const QString& x2) { void* fun = LObjects::overrideFun(unique, 359); bool ret = false; if(fun) { const void* args[] = { &x1, &x2 }; ret = callOverrideFun(fun, 359, args).toBool(); } if(!fun || LObjects::call_default) { ret = QWebPage::javaScriptConfirm(x1, x2); } return ret; }
    void javaScriptConsoleMessage(const QString& x1, int x2, const QString& x3) { void* fun = LObjects::overrideFun(unique, 360); if(fun) { const void* args[] = { &x1, &x2, &x3 }; callOverrideFun(fun, 360, args); } if(!fun || LObjects::call_default) { QWebPage::javaScriptConsoleMessage(x1, x2, x3); }}
    bool javaScriptPrompt(QWebFrame* x1, const QString& x2, const QString& x3, QString* x4) { void* fun = LObjects::overrideFun(unique, 361); bool ret = false; if(fun) { const void* args[] = { &x1, &x2, &x3, &x4 }; ret = callOverrideFun(fun, 361, args).toBool(); } if(!fun || LObjects::call_default) { ret = QWebPage::javaScriptPrompt(x1, x2, x3, x4); } return ret; }
    QString userAgentForUrl(const QUrl& x1) const { void* fun = LObjects::overrideFun(unique, 362); QString ret; if(fun) { const void* args[] = { &x1 }; ret = qVariantValue<QString>(callOverrideFun(fun, 362, args)); } if(!fun || LObjects::call_default) { ret = QWebPage::userAgentForUrl(x1); } return ret; }
...
public:
    ...
    QWebView* createWindow(QWebPage::WebWindowType x1) { void* fun = LObjects::overrideFun(unique, 363); QWebView* ret = 0; if(fun) { const void* args[] = { &x1 }; ret = (QWebView*)qVariantValue<void*>(callOverrideFun(fun, 363, args)); } if(!fun || LObjects::call_default) { ret = QWebView::createWindow(x1); } return ret; }
