...
public:
    ...
    void addHistoryEntry(const QString& x1) { void* fun = LObjects::overrideFun(unique, 322); if(fun) { const void* args[] = { &x1 }; callOverrideFun(fun, 322, args); }}
    bool historyContains(const QString& x1) const { void* fun = LObjects::overrideFun(unique, 323); bool ret = false; if(fun) { const void* args[] = { &x1 }; ret = callOverrideFun(fun, 323, args).toBool(); } return ret; }
...
public:
    ...
    bool extension(Extension x1, const ExtensionOption* x2 = 0, ExtensionReturn* x3 = 0) { void* fun = LObjects::overrideFun(unique, 324); bool ret = false; if(fun) { const void* args[] = { &x1, &x2, &x3 }; ret = callOverrideFun(fun, 324, args).toBool(); } if(!fun || LObjects::call_default) { ret = QWebPage::extension(x1, x2, x3); } return ret; }
    bool supportsExtension(Extension x1) const { void* fun = LObjects::overrideFun(unique, 325); bool ret = false; if(fun) { const void* args[] = { &x1 }; ret = callOverrideFun(fun, 325, args).toBool(); } if(!fun || LObjects::call_default) { ret = QWebPage::supportsExtension(x1); } return ret; }
    void triggerAction(WebAction x1, bool x2 = false) { void* fun = LObjects::overrideFun(unique, 326); if(fun) { const void* args[] = { &x1, &x2 }; callOverrideFun(fun, 326, args); } if(!fun || LObjects::call_default) { QWebPage::triggerAction(x1, x2); }}
    bool acceptNavigationRequest(QWebFrame* x1, const QNetworkRequest& x2, NavigationType x3) { void* fun = LObjects::overrideFun(unique, 327); bool ret = false; if(fun) { const void* args[] = { &x1, &x2, &x3 }; ret = callOverrideFun(fun, 327, args).toBool(); } if(!fun || LObjects::call_default) { ret = QWebPage::acceptNavigationRequest(x1, x2, x3); } return ret; }
    QString chooseFile(QWebFrame* x1, const QString& x2) { void* fun = LObjects::overrideFun(unique, 328); QString ret; if(fun) { const void* args[] = { &x1, &x2 }; ret = qVariantValue<QString>(callOverrideFun(fun, 328, args)); } if(!fun || LObjects::call_default) { ret = QWebPage::chooseFile(x1, x2); } return ret; }
    QObject* createPlugin(const QString& x1, const QUrl& x2, const QStringList& x3, const QStringList& x4) { void* fun = LObjects::overrideFun(unique, 329); QObject* ret = 0; if(fun) { const void* args[] = { &x1, &x2, &x3, &x4 }; ret = (QObject*)qVariantValue<void*>(callOverrideFun(fun, 329, args)); } if(!fun || LObjects::call_default) { ret = QWebPage::createPlugin(x1, x2, x3, x4); } return ret; }
    QWebPage* createWindow(WebWindowType x1) { void* fun = LObjects::overrideFun(unique, 330); QWebPage* ret = 0; if(fun) { const void* args[] = { &x1 }; ret = (QWebPage*)qVariantValue<void*>(callOverrideFun(fun, 330, args)); } if(!fun || LObjects::call_default) { ret = QWebPage::createWindow(x1); } return ret; }
    void javaScriptAlert(QWebFrame* x1, const QString& x2) { void* fun = LObjects::overrideFun(unique, 331); if(fun) { const void* args[] = { &x1, &x2 }; callOverrideFun(fun, 331, args); } if(!fun || LObjects::call_default) { QWebPage::javaScriptAlert(x1, x2); }}
    bool javaScriptConfirm(QWebFrame* x1, const QString& x2) { void* fun = LObjects::overrideFun(unique, 332); bool ret = false; if(fun) { const void* args[] = { &x1, &x2 }; ret = callOverrideFun(fun, 332, args).toBool(); } if(!fun || LObjects::call_default) { ret = QWebPage::javaScriptConfirm(x1, x2); } return ret; }
    void javaScriptConsoleMessage(const QString& x1, int x2, const QString& x3) { void* fun = LObjects::overrideFun(unique, 333); if(fun) { const void* args[] = { &x1, &x2, &x3 }; callOverrideFun(fun, 333, args); } if(!fun || LObjects::call_default) { QWebPage::javaScriptConsoleMessage(x1, x2, x3); }}
    bool javaScriptPrompt(QWebFrame* x1, const QString& x2, const QString& x3, QString* x4) { void* fun = LObjects::overrideFun(unique, 334); bool ret = false; if(fun) { const void* args[] = { &x1, &x2, &x3, &x4 }; ret = callOverrideFun(fun, 334, args).toBool(); } if(!fun || LObjects::call_default) { ret = QWebPage::javaScriptPrompt(x1, x2, x3, x4); } return ret; }
    QString userAgentForUrl(const QUrl& x1) const { void* fun = LObjects::overrideFun(unique, 335); QString ret; if(fun) { const void* args[] = { &x1 }; ret = qVariantValue<QString>(callOverrideFun(fun, 335, args)); } if(!fun || LObjects::call_default) { ret = QWebPage::userAgentForUrl(x1); } return ret; }
...
public:
    ...
    QWebView* createWindow(QWebPage::WebWindowType x1) { void* fun = LObjects::overrideFun(unique, 336); QWebView* ret = 0; if(fun) { const void* args[] = { &x1 }; ret = (QWebView*)qVariantValue<void*>(callOverrideFun(fun, 336, args)); } if(!fun || LObjects::call_default) { ret = QWebView::createWindow(x1); } return ret; }
