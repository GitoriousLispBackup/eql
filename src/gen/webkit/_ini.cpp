...
NumList LWebHistoryInterface::overrideIds = NumList() << 322 << 323;
NumList LWebInspector::overrideIds = NumList() << 25 << 35 << 40 << 41;
NumList LWebPage::overrideIds = NumList() << 324 << 325 << 326 << 327 << 328 << 329 << 330 << 331 << 332 << 333 << 334 << 335;
NumList LWebView::overrideIds = NumList() << 336 << 23 << 25 << 13 << 28 << 29 << 30 << 31 << 32 << 14 << 34 << 15 << 36 << 16 << 17 << 38 << 18 << 19 << 20 << 21 << 40 << 43;
...
const QMetaObject* staticMetaObject(int n) {
    ...
    switch(n) {
        ...
        case 211: m = &QWebFrame::staticMetaObject; break;
        case 212: m = &QWebHistoryInterface::staticMetaObject; break;
        case 213: m = &QWebInspector::staticMetaObject; break;
        case 214: m = &QWebPage::staticMetaObject; break;
...
NumList* override(const QByteArray& name) {
    ...
    if(n != -1) {
        switch(n) {
            ...
            case 212: ids = &LWebHistoryInterface::overrideIds; break;
            case 213: ids = &LWebInspector::overrideIds; break;
            case 214: ids = &LWebPage::overrideIds; break;
