...
public:
    ...
    void drawBranches(QPainter* x1, const QRect& x2, const QModelIndex& x3) const { void* fun = LObjects::overrideFun(unique, 252); if(fun) { const void* args[] = { &x1, &x2, &x3 }; if(callOverrideFun(fun, 252, args).toBool()) return; } QHelpContentWidget::drawBranches(x1, x2, x3); }
    void drawRow(QPainter* x1, const QStyleOptionViewItem& x2, const QModelIndex& x3) const { void* fun = LObjects::overrideFun(unique, 253); if(fun) { const void* args[] = { &x1, &x2, &x3 }; if(callOverrideFun(fun, 253, args).toBool()) return; } QHelpContentWidget::drawRow(x1, x2, x3); }
    void dataChanged(const QModelIndex& x1, const QModelIndex& x2) { void* fun = LObjects::overrideFun(unique, 254); if(fun) { const void* args[] = { &x1, &x2 }; if(callOverrideFun(fun, 254, args).toBool()) return; } QHelpContentWidget::dataChanged(x1, x2); }
    ...
    void reset() { void* fun = LObjects::overrideFun(unique, 120); if(fun) { if(callOverrideFun(fun, 120, 0).toBool()) return; } QHelpContentWidget::reset(); }
    ...
    void selectAll() { void* fun = LObjects::overrideFun(unique, 183); if(fun) { if(callOverrideFun(fun, 183, 0).toBool()) return; } QHelpContentWidget::selectAll(); }
    ...
    void setRootIndex(const QModelIndex& x1) { void* fun = LObjects::overrideFun(unique, 184); if(fun) { const void* args[] = { &x1 }; if(callOverrideFun(fun, 184, args).toBool()) return; } QHelpContentWidget::setRootIndex(x1); }
    ...
    void currentChanged(const QModelIndex& x1, const QModelIndex& x2) { void* fun = LObjects::overrideFun(unique, 185); if(fun) { const void* args[] = { &x1, &x2 }; if(callOverrideFun(fun, 185, args).toBool()) return; } QHelpContentWidget::currentChanged(x1, x2); }
    ...
    void rowsAboutToBeRemoved(const QModelIndex& x1, int x2, int x3) { void* fun = LObjects::overrideFun(unique, 255); if(fun) { const void* args[] = { &x1, &x2, &x3 }; if(callOverrideFun(fun, 255, args).toBool()) return; } QHelpContentWidget::rowsAboutToBeRemoved(x1, x2, x3); }
    void rowsInserted(const QModelIndex& x1, int x2, int x3) { void* fun = LObjects::overrideFun(unique, 186); if(fun) { const void* args[] = { &x1, &x2, &x3 }; if(callOverrideFun(fun, 186, args).toBool()) return; } QHelpContentWidget::rowsInserted(x1, x2, x3); }
    ...
    void selectionChanged(const QItemSelection& x1, const QItemSelection& x2) { void* fun = LObjects::overrideFun(unique, 256); if(fun) { const void* args[] = { &x1, &x2 }; if(callOverrideFun(fun, 256, args).toBool()) return; } QHelpContentWidget::selectionChanged(x1, x2); }
    ...
    void updateGeometries() { void* fun = LObjects::overrideFun(unique, 257); if(fun) { if(callOverrideFun(fun, 257, 0).toBool()) return; } QHelpContentWidget::updateGeometries(); }
...
public:
    ...
    void currentChanged(const QModelIndex& x1, const QModelIndex& x2) { void* fun = LObjects::overrideFun(unique, 185); if(fun) { const void* args[] = { &x1, &x2 }; if(callOverrideFun(fun, 185, args).toBool()) return; } QHelpIndexWidget::currentChanged(x1, x2); }
    void dataChanged(const QModelIndex& x1, const QModelIndex& x2) { void* fun = LObjects::overrideFun(unique, 254); if(fun) { const void* args[] = { &x1, &x2 }; if(callOverrideFun(fun, 254, args).toBool()) return; } QHelpIndexWidget::dataChanged(x1, x2); }
    ...
    void rowsAboutToBeRemoved(const QModelIndex& x1, int x2, int x3) { void* fun = LObjects::overrideFun(unique, 255); if(fun) { const void* args[] = { &x1, &x2, &x3 }; if(callOverrideFun(fun, 255, args).toBool()) return; } QHelpIndexWidget::rowsAboutToBeRemoved(x1, x2, x3); }
    void rowsInserted(const QModelIndex& x1, int x2, int x3) { void* fun = LObjects::overrideFun(unique, 186); if(fun) { const void* args[] = { &x1, &x2, &x3 }; if(callOverrideFun(fun, 186, args).toBool()) return; } QHelpIndexWidget::rowsInserted(x1, x2, x3); }
    ...
    void selectionChanged(const QItemSelection& x1, const QItemSelection& x2) { void* fun = LObjects::overrideFun(unique, 256); if(fun) { const void* args[] = { &x1, &x2 }; if(callOverrideFun(fun, 256, args).toBool()) return; } QHelpIndexWidget::selectionChanged(x1, x2); }
    ...
    void updateGeometries() { void* fun = LObjects::overrideFun(unique, 257); if(fun) { if(callOverrideFun(fun, 257, 0).toBool()) return; } QHelpIndexWidget::updateGeometries(); }
