...
class Q65 : public Q214 { // QGLWidget
    Q_OBJECT
public:
    ...
    Q_INVOKABLE const QGLContext* Mcontext(QGLWidget* o) const { return o->context(); }
    ...
    Q_INVOKABLE void MrenderText(QGLWidget* o, int x1, int x2, const QString& x3, const QFont& x4 = QFont(), int x5 = 2000) { o->renderText(x1, x2, x3, x4, x5); }
    Q_INVOKABLE void MrenderText(QGLWidget* o, double x1, double x2, double x3, const QString& x4, const QFont& x5 = QFont(), int x6 = 2000) { o->renderText(x1, x2, x3, x4, x5, x6); }
    Q_INVOKABLE void MsetColormap(QGLWidget* o, const QGLColormap& x1) { o->setColormap(x1); }
    Q_INVOKABLE void MsetMouseTracking(QGLWidget* o, bool x1) { o->setMouseTracking(x1); }
