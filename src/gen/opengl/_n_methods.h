...
class N42 : public N108 { // QGLFramebufferObject
    Q_OBJECT
public:
    ...
    Q_INVOKABLE void* C(uint u, int x1, int x2, QGLFramebufferObject::Attachment x3, GLenum x4 = GL_TEXTURE_2D, GLenum x5 = GL_RGBA8) { return new LGLFramebufferObject(u, x1, x2, x3, x4, x5); }
    Q_INVOKABLE void* C(uint u, const QSize& x1, QGLFramebufferObject::Attachment x2, GLenum x3 = GL_TEXTURE_2D, GLenum x4 = GL_RGBA8) { return new LGLFramebufferObject(u, x1, x2, x3, x4); }
...
class N44 : public N108 { // QGLPixelBuffer
    Q_OBJECT
public:
