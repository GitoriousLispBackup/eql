...
public:
    ...
    bool create(const QGLContext* x1 = 0) { quint64 id = LObjects::override_id(unique, 405); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; ret = callOverrideFun(fun, 405, args, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QGLContext::create(x1); } return ret; }
    void doneCurrent() { quint64 id = LObjects::override_id(unique, 406); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { callOverrideFun(fun, 406, 0, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QGLContext::doneCurrent(); }}
    void makeCurrent() { quint64 id = LObjects::override_id(unique, 407); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { callOverrideFun(fun, 407, 0, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QGLContext::makeCurrent(); }}
    void swapBuffers() const { quint64 id = LObjects::override_id(unique, 408); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { callOverrideFun(fun, 408, 0, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QGLContext::swapBuffers(); }}
    bool chooseContext(const QGLContext* x1 = 0) { quint64 id = LObjects::override_id(unique, 409); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; ret = callOverrideFun(fun, 409, args, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QGLContext::chooseContext(x1); } return ret; }
};
