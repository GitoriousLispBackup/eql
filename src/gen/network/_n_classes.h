...
public:
    ...
    QList<QNetworkProxy> queryProxy(const QNetworkProxyQuery& x1 = QNetworkProxyQuery()) { void* fun = LObjects::overrideFun(unique, 416); QList<QNetworkProxy> ret; if(fun) { const void* args[] = { &x1 }; ret = qVariantValue<QList<QNetworkProxy> >(callOverrideFun(fun, 416, args)); } return ret; }
};
...
public:
    ...
    void setDir(bool x1) { void* fun = LObjects::overrideFun(unique, 451); if(fun) { const void* args[] = { &x1 }; callOverrideFun(fun, 451, args); } if(!fun || LObjects::call_default) { QUrlInfo::setDir(x1); }}
    void setFile(bool x1) { void* fun = LObjects::overrideFun(unique, 452); if(fun) { const void* args[] = { &x1 }; callOverrideFun(fun, 452, args); } if(!fun || LObjects::call_default) { QUrlInfo::setFile(x1); }}
    void setGroup(const QString& x1) { void* fun = LObjects::overrideFun(unique, 453); if(fun) { const void* args[] = { &x1 }; callOverrideFun(fun, 453, args); } if(!fun || LObjects::call_default) { QUrlInfo::setGroup(x1); }}
    void setLastModified(const QDateTime& x1) { void* fun = LObjects::overrideFun(unique, 454); if(fun) { const void* args[] = { &x1 }; callOverrideFun(fun, 454, args); } if(!fun || LObjects::call_default) { QUrlInfo::setLastModified(x1); }}
    void setName(const QString& x1) { void* fun = LObjects::overrideFun(unique, 455); if(fun) { const void* args[] = { &x1 }; callOverrideFun(fun, 455, args); } if(!fun || LObjects::call_default) { QUrlInfo::setName(x1); }}
    void setOwner(const QString& x1) { void* fun = LObjects::overrideFun(unique, 456); if(fun) { const void* args[] = { &x1 }; callOverrideFun(fun, 456, args); } if(!fun || LObjects::call_default) { QUrlInfo::setOwner(x1); }}
    void setPermissions(int x1) { void* fun = LObjects::overrideFun(unique, 457); if(fun) { const void* args[] = { &x1 }; callOverrideFun(fun, 457, args); } if(!fun || LObjects::call_default) { QUrlInfo::setPermissions(x1); }}
    void setReadable(bool x1) { void* fun = LObjects::overrideFun(unique, 458); if(fun) { const void* args[] = { &x1 }; callOverrideFun(fun, 458, args); } if(!fun || LObjects::call_default) { QUrlInfo::setReadable(x1); }}
    void setSize(qint64 x1) { void* fun = LObjects::overrideFun(unique, 459); if(fun) { const void* args[] = { &x1 }; callOverrideFun(fun, 459, args); } if(!fun || LObjects::call_default) { QUrlInfo::setSize(x1); }}
    void setSymLink(bool x1) { void* fun = LObjects::overrideFun(unique, 460); if(fun) { const void* args[] = { &x1 }; callOverrideFun(fun, 460, args); } if(!fun || LObjects::call_default) { QUrlInfo::setSymLink(x1); }}
    void setWritable(bool x1) { void* fun = LObjects::overrideFun(unique, 461); if(fun) { const void* args[] = { &x1 }; callOverrideFun(fun, 461, args); } if(!fun || LObjects::call_default) { QUrlInfo::setWritable(x1); }}
};
