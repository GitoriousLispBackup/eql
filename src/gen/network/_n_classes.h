...
public:
    ...
    QList<QNetworkProxy> queryProxy(const QNetworkProxyQuery& x1 = QNetworkProxyQuery()) { quint64 id = LObjects::override_id(unique, 416); void* fun = LObjects::overrideFun(id); QList<QNetworkProxy> ret; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; ret = qVariantValue<QList<QNetworkProxy> >(callOverrideFun(fun, 416, args, id)); } return ret; }
};
...
public:
    ...
    void setDir(bool x1) { quint64 id = LObjects::override_id(unique, 451); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 451, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QUrlInfo::setDir(x1); }}
    void setFile(bool x1) { quint64 id = LObjects::override_id(unique, 452); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 452, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QUrlInfo::setFile(x1); }}
    void setGroup(const QString& x1) { quint64 id = LObjects::override_id(unique, 453); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 453, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QUrlInfo::setGroup(x1); }}
    void setLastModified(const QDateTime& x1) { quint64 id = LObjects::override_id(unique, 454); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 454, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QUrlInfo::setLastModified(x1); }}
    void setName(const QString& x1) { quint64 id = LObjects::override_id(unique, 455); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 455, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QUrlInfo::setName(x1); }}
    void setOwner(const QString& x1) { quint64 id = LObjects::override_id(unique, 456); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 456, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QUrlInfo::setOwner(x1); }}
    void setPermissions(int x1) { quint64 id = LObjects::override_id(unique, 457); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 457, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QUrlInfo::setPermissions(x1); }}
    void setReadable(bool x1) { quint64 id = LObjects::override_id(unique, 458); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 458, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QUrlInfo::setReadable(x1); }}
    void setSize(qint64 x1) { quint64 id = LObjects::override_id(unique, 459); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 459, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QUrlInfo::setSize(x1); }}
    void setSymLink(bool x1) { quint64 id = LObjects::override_id(unique, 460); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 460, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QUrlInfo::setSymLink(x1); }}
    void setWritable(bool x1) { quint64 id = LObjects::override_id(unique, 461); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 461, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QUrlInfo::setWritable(x1); }}
};
