...
;;;
;;; Several 'Q' macro regions are used here:
;;;
;;;   - IN-PACKAGE needs its own (otherwise it's not considered a top-level form)
;;;   - PAINT has its own for convenient "eval region" in Slime
...
(q (defvar *sinus* #(0 38 71 92 100 92 71 38 0 -38 -71 -92 -100 -92 -71 -38)))
   
(q (defvar *wiggly* (qnew "QWidget" "autoFillBackground" t))
